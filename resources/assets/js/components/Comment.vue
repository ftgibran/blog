            ...
            <div :class="contentWrapperClass">
                ...
                <form class="form-horizontal" style="margin-top: 30px;" @submit.prevent="comment" v-if="canComment">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="content" rows="7" name="content" v-model="content"
                ...
                <form class="form-horizontal" style="margin-top: 30px;" @submit.prevent="commentAsGuest"
                      v-if="guestComment">
                    <div class="form-group">
                        <label for="nome" class="col-sm-2 control-label">Nome</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nome" v-model="guestName" placeholder="Nome" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="email" v-model="guestEmail" placeholder="Email" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label own-avatar">
                            <img class="img-circle" src="/images/default.png">
                        </label>
                        <div class="col-sm-10">
                            <textarea class="form-control" id="guest-content" rows="7" name="content" v-model="content"
                                      placeholder="Markdown"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    export default {
        ...
        methods: {
            ...
            commentAsGuest() {
                ...
                this.$http.post('/api/comments/guest', data)
                        .then((response) => {
                            let comment = null;
                            comment = response.data.data;
                            comment.content_html = this.parse(comment.content_raw);
